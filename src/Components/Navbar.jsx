        ...
        <nav className="fixed top-0 w-full z-50 bg-[#0d2440]/90 backdrop-blur-md border-b border-[#1a1a1a]">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div className="flex items-center">
                    ...
                    <a href='/contacto' className="hidden md:block px-5 py-2 border border-[#7ba4d0] text-[#7ba4d0] text-[10px] uppercase tracking-widest font-black hover:bg-[#7ba4d0] hover:text-white transition-all duration-300 rounded-[2px]">
                        Empezar Proyecto
                    </a>

                    <button
                        onClick={toggleMenu}
                        className="md:hidden text-[#7ba4d0] focus:outline-none p-2">
                        {isOpen ? (
            ...
            <div
                className={`md:hidden absolute top-20 left-0 w-full bg-[#0d2440]/95 backdrop-blur-md border-b border-[#1a1a1a] transition-all duration-300 overflow-hidden ${isOpen ? 'max-h-80 border-t' : 'max-h-0 border-transparent opacity-0'
                    }`} >
