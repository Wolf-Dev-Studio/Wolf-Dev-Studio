    ...
    return (
        <nav className="fixed top-0 w-full z-10 bg-[#0d2440]/80 backdrop-blur-md border-b border-[#1a1a1a]">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                {/* BOTÓN DE ACCIÓN (CTA) */}
                <a href='contacto' className="px-5 py-2 border border-[#7ba4d0] text-[#7ba4d0] text-[10px] uppercase tracking-widest font-black hover:bg-[#7ba4d0] hover:text-white transition-all duration-300 rounded-[2px]">
                    Empezar Proyecto
                </a>
