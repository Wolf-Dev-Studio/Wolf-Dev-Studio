                    ...
                    {proyectos.map((proyecto, index) => (
                        <div key={index} className="group ">
                            ...
                            <div className="flex justify-between items-start">
                                ...
                                <a href={proyecto.link} className="w-10 h-10 border-2 border-[#1a1a1a] flex items-center justify-center text-gray-500 hover:text-[#7ba4d0] hover:border-[#7ba4d0] transition-colors rounded-full">
